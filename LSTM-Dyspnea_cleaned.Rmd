...
data.frame(N.True = n.true, # 105
           N.Predicted = n.predicted, # 105
           Accuracy = cm$overall[["Accuracy"]], # 0.991
           Precision = cm$byClass[["Precision"]], # 0.542
           Recall = cm$byClass[["Recall"]], # 0.542
           F1 = cm$byClass[["F1"]]) # 0.542
```
...
predict_classes_w2v <- if_else(predict_x.w2v[,1] > prob_threshold, 1, 0)
...
data.frame(N.True = n.true, # 105
           N.Predicted = n.predicted.w2v, # 139
           Accuracy = cm_w2v$overall[["Accuracy"]], # 0.989
           Precision = cm_w2v$byClass[["Precision"]], # 0.437
           Recall = cm_w2v$byClass[["Recall"]], # 0.695
           F1 = cm_w2v$byClass[["F1"]]) # 0.537
```
