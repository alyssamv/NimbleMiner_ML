...
# Max length for each document is about 5 times the length of 1 sentence. 
...
cm_5 = caret::confusionMatrix(factor(predict_x[,1], levels = c(0,1 )), 
                            factor(y_test, levels = c(0, 1)),
                            positive = "1")

data.frame(Accuracy = cm_5$overall[["Accuracy"]],
           Precision = cm_5$byClass[["Precision"]],
           Recall = cm_5$byClass[["Recall"]],
           F1 = cm_5$byClass[["F1"]])
```
