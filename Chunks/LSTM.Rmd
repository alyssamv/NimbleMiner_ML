...
```{r lstm_test5}
# Accuracy ~70%%; Loss 0.85
results_5 = model_lstm %>%
 evaluate(x_test, y_test)
```
...
```{r lstm_test10}
# Accuracy ~63.7%%; Loss 1.07
results_10 = model_lstm %>%
 evaluate(x_test, y_test)
```
